    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link href="/parent/understand/upload?type=iep" className="card text-center hover:border-brand-300">
          ...
          <p className="text-xs text-brand-500">Goals, services, accommodations</p>
        </Link>
        <Link href="/parent/understand/upload?type=triennial" className="card text-center hover:border-brand-300">
          ...
          <p className="text-xs text-brand-500">Assessment scores, eligibility</p>
        </Link>
      </div>
          ...
          {docs.map((d) => (
            <li key={d.id}>
              ...
              >
                ...
                <span className="pill bg-brand-50 text-brand-600">View →</span>
              </Link>
            </li>
          ))}
          {!docs.length && (
